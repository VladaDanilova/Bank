  ...
  //combo box to display the account types.
   ...
   try {
	...
	WithdrawJTextField.setText("0");
    	...
    	//Update the if statement that adds accounts to the system (After the finally block in the
   ...
   try {
	...
	public static void displayAccountDetails(AbstractBankAccount a){
			//displayJTextArea.setText(a.toString());
